                    ...
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="contact-item">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-4">
                                    <h4>Addresses</h4>
                                    <p class="mb-0">Makepe, Douala</p>
                                    <p class="mb-0">Bastos, Yaounde</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-4">
                                    <h4>Mobile</h4>
                                    <p class="mb-0">+237 690-45-93-04</p>
                                    <p class="mb-0">+237 682-847-784</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-4">
                                    <h4>Email</h4>
                                    <p class="mb-0">ashuesthy@gmail.com</p>
                                    <p class="mb-0">dadaestate45@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
